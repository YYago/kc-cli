...
${logRed('kc watch')} ${logYellow('[ignore...]')} 监视任务，当文件发生改变的时候自动执行相应的操作。结果：'kc summary' 和 'kc md'。
                [ignore...] 排除不监视的文件或文件夹。
...
---------------------------
${logCyan('注意：在构建 Docx、HTML 文件之前，你需要安装 Pandoc 并添加到 PATH，也许你需要配置 pandoc，具体见 pandoc 的文档。')}
`
module.exports = {
    err: log_err,
    warn: log_warn,
